...
const Accessibility = function () {
	return (
		<>
			<Hero heading="Accessibility statement" />
			<section className="legal fb-col-wrapper">
				...
				<p className="legal__paragraph">
					...
					2.1 AA standard, as described in the Equality Act 2010, to ensure that our website is easy
					to navigate and interact with for everyone.
				</p>
				...
				<ul className="legal__list">
					...
					<li className="legal__list-item">
						Ensure our website is compatible with screen readers.
					</li>
					<li className="legal__list-item">
						Offer keyboard navigation for all interactive elements.
					</li>
					<li className="legal__list-item">
						Use descriptive alt text for images where applicable.
					</li>
				</ul>
				...
				<p className="legal__paragraph">
					...
					difficulty accessing or interacting with content, please contact the site owner so the
