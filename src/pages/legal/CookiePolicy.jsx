...
const CookiePolicy = function () {
	return (
		<>
			<Hero heading="Cookie policy" />
			<section className="legal fb-col-wrapper">
				<h2 className="legal__subheading">What are cookies?</h2>
				<p className="legal__paragraph">
					Cookies are small text files stored on your device to help a website function properly.
					They enable core features such as security, accessibility, and session management. Cookies
					may track, save and store information about the user&apos;s interactions and usage of the
				...
				<p className="legal__paragraph">
					<strong>
						This website only uses essential cookies, which are strictly necessary for the website
						to operate. These cookies do not track, store, or collect personal data for marketing or
						analytics purposes.
					</strong>
				</p>
				...
				<p className="legal__paragraph">
					...
					note that blocking essential cookies may impact this and other website&apos;s
					functionality.
				</p>
			</section>
		</>
