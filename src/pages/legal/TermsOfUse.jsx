		...
		<>
			...
			<section className="legal fb-col-wrapper">
				<p className="legal__paragraph">
					...
					relationship with you concerning this website. If you disagree with any part of these
				...
				<p className="legal__paragraph">
					...
					this website. The term &quot;you&quot; refers to the user or viewer of this website. The
