		...
		<>
			...
			<section className="legal fb-col-wrapper">
				<p className="legal__paragraph">
					This privacy policy is for this website and is served by {siteName} and governs the
				...
				<p className="legal__paragraph">
					...
					obligations and requirements of the users, the website and the website owners.
					Furthermore, the way this website processes, stores and protects user data and information
				...
				<p className="legal__paragraph">
					...
					private and stored securely until a time it is no longer required or has no use, as
					detailed in the Data Protection Act 1998. Every effort has been made to ensure a safe and
					secure form-to-email submission process, but it is advised that users using such
					form-to-email processes do so at their own risk.
				</p>
				<p className="legal__paragraph">
				...
				<p className="legal__paragraph">
					...
					users are advised to adopt a policy of caution before clicking any external web links
				...
				<p className="legal__paragraph">
					...
					external links at their own risk. This website and its owners cannot be held liable for
				...
				<p className="legal__paragraph">
					...
					this website and its owners participate in are custom to the terms and conditions as well
					as the privacy policies held with each social media platform respectively.
				</p>
				<p className="legal__paragraph">
					Users are advised to use social media platforms wisely and communicate/engage with them
					with due care and caution regarding their privacy and personal details. This website nor
					its owners will ever ask for personal or sensitive information through social media
