...
const testimonials = [
	"The BEST preschool with the friendliest staff! Always going above and beyond to ensure the children are always happy and having lots of fun. 😊",
	"The staff at Thurton Preschool worked so incredibly hard over a period of months to help my son settle in. They formed bonds and created an environment that he now cannot wait to go to everyday. The team truly know and care for each child. I wouldn't hesitate to recommend Thurton.",
	...
	"We would be lost without Ellen and the team at Thurton Preschool. They are so caring and dedicated to each child as an individual, they make it very easy to leave our daughter there, knowing she is in good hands.",
	"A nurturing and caring preschool. We are very pleased to have found it! The fundraising they do is fantastic. It helps keep fees down and strengthens the community.",
	"My favourite thing is seeing my friends and I like glue and sticking and painting things. I have banana and raisins. My teachers play babies with me in the Fox Den. I love all the lots of babies and songs. H, age 2.",
	"My son and I absolutely love Thurton and Ashby Preschool. For someone who is very particular about who cares for my child, I can honestly say I feel beyond happy dropping him off, as the team go above and beyond to make sure he is happy and content. They focus on his individual interests and allow him to explore them further within the setting. He loves preschool!",
	"We are so pleased we moved our son to Thurton Preschool. He settled in very quickly and he loves it there. He is always very happy to go, and often talks about preschool at home. We have been very impressed with the range of activities they provide and staff communication has been great. Lovely people and real sense of community!",
	...
	"My son absolutely loves going to preschool and has thrived since he started. Being outdoors all year round has had so many benefits where is has loved learning through the seasons. The Woodland Wanderers sessions are so unique. I couldn't have asked for a better start for him.",
];
		...
		<section className="testimonials fb-col-wrapper">
			...
			>
				{testimonials.map((testimonial, i) => (
					<Testimonial key={i} body={testimonial} index={i + 1} />
				))}
			</div>
		</section>
	);
